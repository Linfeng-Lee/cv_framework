...
class ScriptModel():
    def __init__(self, model_path, cls_, h, w):
        ...
        # self.model.load_state_dict(static_dict, strict=False)
        self.h = h
        self.w = w
...
if __name__ == "__main__":
    cls_ = 2
    w, h = 320, 192
    model_path = r"model_20221010\shufflenetv2_embedding_11_320x192_2022-10-10.torchscript.pt"
    input_dir = r"test_image"
    template_path = r"model_20221010\template_norm_2022-10-10.json"
