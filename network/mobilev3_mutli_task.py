...
def PFLDnet(pretrained:bool=False,progress: bool=True,**kwargs: Any):
...
class PFLDInference(nn.Module):
    def __init__(self):
        ...
        self.conv8 = conv_bn(32, 64, 3, 2)  # [32, 7, 7]
        self.conv9 = nn.Conv2d(64, 64, 7, 1, 0)  #gg [128, 1, 1]
        self.bn9 = nn.BatchNorm2d(128)

        self.avg_pool1 = nn.AvgPool2d(14)
        self.avg_pool2 = nn.AvgPool2d(7)
        self.fc = nn.Linear(7168,3)
