...
if __name__ == "__main__":
    ...
    # 部署mode
    model_path = r"E:\泡罩交接项目\双鲸胶囊项目\模型\部署用模型\model_20221018/shufflenetv2_embedding_11_320x192_2022-10-18.torchscript.pt"
    template_path = r'E:\泡罩交接项目\双鲸胶囊项目\模型\部署用模型\model_20221018/template_norm_2022-10-18.json'
