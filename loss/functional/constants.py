...
#: Target mask shape - (N, H, W), models output mask shape (N, 1, H, W).
...
#: Target mask shape - (N, H, W), models output mask shape (N, C, H, W).
...
#: Target mask shape - (N, C, H, W), models output mask shape (N, C, H, W).
