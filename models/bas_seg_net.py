...
from network.resnet_model import *
...
class BasSegNet(nn.Module):
    def __init__(self,n_channels=3,**kwargs):
        super(BasSegNet, self).__init__()
...
def _bas_seg_net(arch: str, pretrained: bool, progress: bool, *args: Any, **kwargs: Any) -> BasSegNet:
    model = BasSegNet(*args, **kwargs)
...
def bas_seg_net_v1(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> BasSegNet:
    """
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _bas_seg_net('bas_seg_net_v1', pretrained, progress, **kwargs)
